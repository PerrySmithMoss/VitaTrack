                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      Sort by
                          ...
                          <option value="mostFrequent">Frequent</option>
                      ...
                      <table className={styles.addFoodDrawerTable}>
                        <tbody>
                          <tr className="favorite">
                            ...
                            <td>
                              <strong className="pr-1">Qty:</strong>
                              <input
                                autoComplete="off"
                          ...
                          <tr className="favorite">
                            ...
                            <td>
                              Per4m&nbsp;Whey - Choc&nbsp;Brownie&nbsp;Battet
                            </td>
                          ...
                          <tr className="favorite">
                            ...
                            <td>
                              ...
                              >
                                <option value="1114931380">
                                  4 squares (40g)
                                </option>
                                <option value="1114931381">1.4 ounce</option>
                                <option value="1114931382">
                                  1 squares (40g)
                                </option>
                                <option
                                  value="1114931383"
                          ...
                          <tr className="favorite">
                            ...
                            <td>
                              ...
                              >
                                ...
                                <option value="545393801">
                                  1 NLEA serving
                                </option>
                                <option value="545393802">100 g</option>
                                <option value="545393803">
                                  1 cup, chopped
                                </option>
